...
const CartInfo = () => {
  ...
  return (
     ...
     <div className="px-4 py-2">
                ...
                {cartData.length === 0 ? (
                    <p className="text-[#ababab] text-sm flex justify-center items-center h-[380px]">Your cart is empty. Start adding some delicious items !</p>
                ...
                <div className="flex items-center justify-between mt-3">
                    ...
                    <p className="text-[#f5f5f5] text-md font-bold">Nrs. {item.price}</p>
                </div>
                </div>
                    )
                })}
