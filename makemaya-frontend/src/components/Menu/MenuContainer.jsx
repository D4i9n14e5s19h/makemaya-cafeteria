  ...
  return (
    <>
      <div className='grid grid-cols-4 gap-4 px-10 py-4 w-[100%]'>
        ...
        menus.map((menu) => {
          return (
            <div key={menu.id} className='flex flex-col items-start justify-between p-4 rounded-lg h-[100px] cursor-pointer' style={{backgroundColor: menu.bgColor}}
      ...
      <hr className='border-[#2a2a2a] border-t-2-a mt-4' />
          ...
          return (
            <div key={item.id} className='flex flex-col items-start justify-between p-4 rounded-lg h-[150px] cursor-pointer hover:bg-[#2a2a2a] bg-[#1a1a1a] '>
                ...
                <h1 className='text-[#f5f5f5] text-lg font-semibold'>
                 ...
                 <p className='text-[#f5f5f5] text-xl font-bold'>Nrs. {item.price}</p>
